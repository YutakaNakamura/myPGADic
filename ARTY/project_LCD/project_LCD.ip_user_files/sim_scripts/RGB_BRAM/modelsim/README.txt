...
#
# Generated by export_simulation on Tue Feb 11 00:27:03 +0900 2020
#
################################################################################
...
'-reset_run' switch to the './RGB_BRAM.sh' script.

./RGB_BRAM.sh -reset_run
...
./RGB_BRAM.sh -noclean_files

For more information on the script, please type './RGB_BRAM.sh -help'.
