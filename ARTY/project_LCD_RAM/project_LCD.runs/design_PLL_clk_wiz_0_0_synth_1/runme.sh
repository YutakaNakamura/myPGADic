...
HD_PWD='E:/Xilinx/workspace/ARTY/project_LCD/project_LCD.runs/design_PLL_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_PLL_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_PLL_clk_wiz_0_0.tcl
