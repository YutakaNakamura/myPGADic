...
HD_PWD='E:/Xilinx/workspace/PYNQ_Z2/project_LCD_withZynq/project_LCD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log HPS_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source HPS_wrapper.tcl -notrace
