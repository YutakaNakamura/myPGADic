...
HD_PWD='E:/Xilinx/workspace/PYNQ_Z2/project_LCD/project_LCD.runs/RGB_BRAM_blk_mem_gen_R_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RGB_BRAM_blk_mem_gen_R_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RGB_BRAM_blk_mem_gen_R_0.tcl
