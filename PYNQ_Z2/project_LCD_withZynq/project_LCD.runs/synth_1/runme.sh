...
HD_PWD='E:/Xilinx/workspace/PYNQ_Z2/project_LCD_withZynq/project_LCD.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HPS_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HPS_wrapper.tcl
