...
HD_PWD='E:/Xilinx/workspace/PYNQ_Z2/project_LCD_withZynq/project_LCD.runs/HPS_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HPS_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HPS_processing_system7_0_0.tcl
