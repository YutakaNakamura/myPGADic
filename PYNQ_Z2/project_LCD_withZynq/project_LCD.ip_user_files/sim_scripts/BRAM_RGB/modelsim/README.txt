...
#
# Generated by export_simulation on Tue Feb 11 01:49:39 +0900 2020
#
################################################################################
...
'-reset_run' switch to the './BRAM_RGB.sh' script.

./BRAM_RGB.sh -reset_run
...
./BRAM_RGB.sh -noclean_files

For more information on the script, please type './BRAM_RGB.sh -help'.
