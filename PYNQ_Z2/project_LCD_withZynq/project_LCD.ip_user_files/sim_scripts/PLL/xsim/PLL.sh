...
simulate()
{
  xsim PLL -key {Behavioral:sim_1:Functional:PLL} -tclbatch cmd.tcl -protoinst "protoinst_files/RGB_BRAM.protoinst" -protoinst "protoinst_files/design_PLL.protoinst" -protoinst "protoinst_files/PLL.protoinst" -log simulate.log
}
