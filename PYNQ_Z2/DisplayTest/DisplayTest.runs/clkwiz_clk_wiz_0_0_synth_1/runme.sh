...
HD_PWD='E:/Xilinx/workspace/PYNQ_Z2/DisplayTest/DisplayTest.runs/clkwiz_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clkwiz_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clkwiz_clk_wiz_0_0.tcl
