...
HD_PWD='E:/Xilinx/workspace/PYNQ_Z2/DisplayTest/DisplayTest.runs/blkmem_blk_mem_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blkmem_blk_mem_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blkmem_blk_mem_gen_0_0.tcl
