...
vlog -work xil_defaultlib -64 -incr -sv -L axi_vip_v1_1_4 -L processing_system7_vip_v1_0_6 -L xilinx_vip "+incdir+E:/Xilinx/Vivado/2018.3/data/xilinx_vip/include" \
...
vlog -work blk_mem_gen_v8_4_2 -64 -incr "+incdir+E:/Xilinx/Vivado/2018.3/data/xilinx_vip/include" \
"../../../../DisplayTest.srcs/sources_1/bd/blkmem/ipshared/37c2/simulation/blk_mem_gen_v8_4.v" \

vlog -work xil_defaultlib -64 -incr "+incdir+E:/Xilinx/Vivado/2018.3/data/xilinx_vip/include" \
