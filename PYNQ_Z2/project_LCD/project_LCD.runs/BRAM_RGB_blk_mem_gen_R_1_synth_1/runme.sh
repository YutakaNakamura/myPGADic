...
HD_PWD='E:/Xilinx/workspace/PYNQ_Z2/project_LCD/project_LCD.runs/BRAM_RGB_blk_mem_gen_R_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BRAM_RGB_blk_mem_gen_R_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BRAM_RGB_blk_mem_gen_R_1.tcl
