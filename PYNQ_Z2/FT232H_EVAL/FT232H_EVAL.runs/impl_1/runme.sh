...
HD_PWD='E:/Xilinx/workspace/PYNQ_Z2/FT232H_EVAL/FT232H_EVAL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FT232EVAL.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FT232EVAL.tcl -notrace
