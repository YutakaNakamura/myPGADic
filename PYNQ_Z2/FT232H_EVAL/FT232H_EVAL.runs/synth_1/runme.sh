...
HD_PWD='E:/Xilinx/workspace/PYNQ_Z2/FT232H_EVAL/FT232H_EVAL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FT232EVAL.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FT232EVAL.tcl
