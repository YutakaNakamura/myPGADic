...
HD_PWD='E:/Xilinx/workspace/ARTY_Z7/project_1/project_1.runs/design_1_myip_LED_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_myip_LED_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_myip_LED_0_0.tcl
