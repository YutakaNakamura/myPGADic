...
set rc [catch {
  ...
  open_checkpoint E:/Xilinx/workspace/QM_Artix7DDR3CoreBoard/Test01_project_led/project_led.runs/impl_1/led_top.dcp
...
set rc [catch {
  ...
  write_bitstream -force led_top.bit -bin_file
